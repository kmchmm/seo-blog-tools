...
const Hunter: FC = () => {
  ...
  return (
    <div
      ...
      <Button onClick={handleOpenModal} className="mt-5 w-[150px] !bg-black-200 !text-white hover:!bg-black dark:!bg-transparent dark:hover:!bg-yellow-100 hover:text-white-100 dark:hover:!text-black-200 hover:!shadow-none !py-3 !px-5">Open Modal</Button> {/* Button that opens the modal */}
        ...
        >
          <div className="relative h-full w-full">
            ...
            <div className="mt-4">
              <div className="flex items-center py-3">
                <div className="flex !items-center !w-1/2 gap-3">
                  <input type="checkbox" id="partialReplacement" className="cursor-pointer"/>
                  <label htmlFor="partialReplacement" className="cursor-pointer">Partial Replacement?</label>
                </div>
                <span className="!w-1/2">Allow partial replacement of words. (e.g. success in successful)</span>
              </div>
              <div className="flex items-center py-3">
                <div className="flex !items-center !w-1/2 gap-3">
                  <input type="checkbox" id='lookPost' className="cursor-pointer"/>
                  <label htmlFor="lookPost" className="cursor-pointer">Look in Post?</label>
                </div>
              ...
              <div className="flex items-center py-3">
                <div className="flex !items-center !w-1/2 gap-3 ">
                  ...
                  <label htmlFor="lookPages" className="cursor-pointer">Look in Pages?</label>
                </div>
            ...
            <div className="flex gap-4 absolute bottom-0 right-0">
              <button className="border border-blue-400 cursor-pointer py-2 px-7 bg-blue-400 hover:bg-blue-950 text-white hover:border-blue-800">Save</button>
              <button onClick={handleCloseModal} className="border border-white cursor-pointer py-2 px-7 hover:bg-red-100 hover:border-red-100">Cancel</button>
            </div>
          </div>
        </Modal>
      )}
            ...
            <div className="paa-table-container m-0 p-0 w-full">
              <table
                ...
                <thead>
                  <tr>
                    <th className="w-1/4 border border-black-200 dark:border-amber-200">Keyword</th>
                    <th className="w-1/2 border border-black-200 dark:border-amber-200">Link/Url</th>
                    <th className="w-1/4 border border-black-200 dark:border-amber-200">Last Update</th>
                    <th className="w-[150px] border border-black-200 dark:border-amber-200 !text-center">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
